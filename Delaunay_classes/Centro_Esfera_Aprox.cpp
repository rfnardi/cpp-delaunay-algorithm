...
del::Point del::Find_Centro_Esfera::retorna_centro(del::Point A, del::Point B, del::Point C)
{
  ...
  //montando o jacobiano:
  del::Find_Centro_Esfera::Jacobiano[0][0] = 2*(Centro_0.p[0]-A.p[0]);
  del::Find_Centro_Esfera::Jacobiano[0][1] = 2*(Centro_0.p[1]-A.p[1]);
  del::Find_Centro_Esfera::Jacobiano[0][2] = 2*(Centro_0.p[2]-A.p[2]);

  del::Find_Centro_Esfera::Jacobiano[1][0] = 2*(Centro_0.p[0]-B.p[0]);
  del::Find_Centro_Esfera::Jacobiano[1][1] = 2*(Centro_0.p[1]-B.p[1]);
  del::Find_Centro_Esfera::Jacobiano[1][2] = 2*(Centro_0.p[2]-B.p[2]);

  del::Find_Centro_Esfera::Jacobiano[2][0] = 2*(Centro_0.p[0]-C.p[0]);
  del::Find_Centro_Esfera::Jacobiano[2][1] = 2*(Centro_0.p[1]-C.p[1]);
  del::Find_Centro_Esfera::Jacobiano[2][2] = 2*(Centro_0.p[2]-C.p[2]);
